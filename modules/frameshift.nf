process frameshift {
    ...
    bcftools sort tmp.vcf | bcftools norm -c w -d all -f \${GENOME_FASTA} | bcftools norm -c w -m -indels -f \${GENOME_FASTA} | bcftools filter -O z -o medaka_2nd_and_varscan_final.vcf.gz -i "QUAL >= 0 && INFO/DP >= 1"
